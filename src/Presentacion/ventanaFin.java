...
public class ventanaFin extends JFrame {
	...
	public ventanaFin() {
		...
		JLabel lblTitulo = new JLabel("FELICIDADES MANUEL!");
		...
		JLabel lblSegundo = new JLabel("2. Pepe");
		...
		JLabel lblPrimero = new JLabel("1. Manuel");
		lblPrimero.setFont(new Font("Yu Gothic Medium", Font.BOLD, 16));
		...
		JLabel lblTercero = new JLabel("3. Yoseba");
		...
		JLabel lblCuarto = new JLabel("New label");
		...
		JLabel lblQuinto = new JLabel("New label");
		...
		JLabel lblSexto = new JLabel("New label");
